      ...
      <Container>
        ...
        <Reveal delay={90}>
          <p className="text-lead mt-6 max-w-[54ch] text-ink-muted">
            The residence is in Bayview Villas, on the Paralimni-Protaras coast
            in the Ammochostos district of Cyprus.
          </p>
        </Reveal>
        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.6fr)] lg:gap-16">
          <Reveal delay={140}>
            <dl>
              ...
              <Detail term="Plus Code">22CV+GW7 Paralimni</Detail>
