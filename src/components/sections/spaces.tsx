            ...
            <Reveal variant="mask">
              ...
              >
                <Image
                  ...
                  alt="The dining table with the living room beyond it."
                  fill
        ...
        <Container>
          <div className="grid gap-16 lg:grid-cols-12">
            <Reveal variant="drape" className="lg:col-span-4">
              ...
              <p className="text-lead mt-8 text-ink-muted">
                Privacy continues throughout the residence.
              </p>
            </Reveal>
              ...
              <Reveal variant="mask">
                ...
                >
                  <Image
                    ...
                    alt="A double bedroom opening onto its own balcony."
                    fill
              ...
              <Reveal variant="mask" delay={160} className="sm:mt-20">
                ...
                >
                  <Image
                    ...
                    alt="A bathroom with a walk-in shower."
                    fill
                    sizes="(min-width: 1024px) 30vw, 50vw"
                    className="object-cover"
                  />
      ...
      <section className="relative flex min-h-[86dvh] items-end overflow-clip py-24">
        <Parallax distance={-80} className="absolute inset-0">
          <Image
            ...
            alt="The covered terrace lounge alongside the pool."
            fill
            sizes="100vw"
            className="object-cover"
          />
        ...
        <Container className="relative">
          ...
          <Reveal delay={120} className="mt-10 max-w-[52ch]">
            <p className="text-lead text-on-dark/85">
              In Cyprus, outdoor living should never feel secondary. At MIS
              Private Residence, it is part of the architecture.
            </p>
